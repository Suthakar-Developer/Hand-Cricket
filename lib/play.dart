...
class PlayBat extends StatefulWidget {
  @override
  _PlayBatState createState() => _PlayBatState();
}

class _PlayBatState extends State<PlayBat> {
  int cnum = 0;
  int start;
  int unum = 0;
  var uscore = 0;
  ...
  void calculate(int x) {
    ...
    if (wicket == 0) {
      if (cno != uno) {
        ...
        Alert(
          ...
          type: AlertType.info,
          title: "OUT",
          desc: "Computer needs $target runs to win.",
          buttons: [
            DialogButton(
              child: Text(
                "CONTINUE",
    ...
    if (wicket == 1 && start != 0) {
      uno = 0;
      if (cnum != unum && cscore <= uscore) {
        cscore = cscore + cno;
      } else if (cnum == unum) {
        wicket = 2;
        cno = 0;
      }
      if (wicket == 1 && cscore > uscore) {
        w = 2;
      } else if (wicket == 2 && cscore < uscore) {
        w = 1;
      }
      if (w == 1) {
        showDialog(
